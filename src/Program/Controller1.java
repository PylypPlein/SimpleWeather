        ...
        getData.setOnAction(event-> {
            ...
            if(!getUserCity.equals("")) {
                ...
                if (!output.isEmpty()) {
                    ...
                    temp_info.setText("TEMPERATURE: " + (obj.getJSONObject("main").getInt("temp")- 273.00) + " C");
                    temp_max.setText("MAX: " + (obj.getJSONObject("main").getInt("temp_max")- 273.00) + " C");
                    temp_min.setText("MIN: " + (obj.getJSONObject("main").getInt("temp_min")- 273.00) + " C");
